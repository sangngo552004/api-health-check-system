...
- Quản lý API và dịch vụ theo các nhóm làm việc (Team-based Workspace/Multi-tenancy), giúp các team quản lý tập trung API của riêng mình.
...
- Hiển thị Team Dashboard và Global Dashboard tổng quan và lịch sử kiểm tra.
- Ghi nhận incident và phát cảnh báo khi dịch vụ gặp lỗi liên tục.
- Quản lý nhóm nhận thông báo (Contact Groups) linh hoạt qua Email, Webhook theo từng Workspace.
...
- [Kế hoạch & Đánh giá Database Workspace Phase 4](docs/phase-4/database-redesign-and-sprint-plan.md)
